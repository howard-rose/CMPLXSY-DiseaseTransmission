...
public class ProductShelfGraphic extends GroceryAmenityGraphic {
    ...
    public ProductShelfGraphic(ProductShelf productShelf) {
        super(productShelf, ROW_SPAN, COLUMN_SPAN, NORMAL_ROW_OFFSET, NORMAL_COLUMN_OFFSET);
    }
