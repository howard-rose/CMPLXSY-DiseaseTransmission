...
public class ServiceCounterGraphic extends GroceryAmenityGraphic {
    ...
    public ServiceCounterGraphic(ServiceCounter serviceCounter) {
        super(serviceCounter, ROW_SPAN, COLUMN_SPAN, NORMAL_ROW_OFFSET, NORMAL_COLUMN_OFFSET);
    }
