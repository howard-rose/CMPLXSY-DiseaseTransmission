...
public class GroceryGateGraphic extends GroceryAmenityGraphic {
    ...
    public GroceryGateGraphic(GroceryGate groceryGate) {
        super(groceryGate, ROW_SPAN, COLUMN_SPAN, NORMAL_ROW_OFFSET, NORMAL_COLUMN_OFFSET);
    }
