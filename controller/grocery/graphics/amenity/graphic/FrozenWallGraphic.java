...
public class FrozenWallGraphic extends GroceryAmenityGraphic {
    ...
    public FrozenWallGraphic(FrozenWall frozenWall) {
        super(frozenWall, ROW_SPAN, COLUMN_SPAN, NORMAL_ROW_OFFSET, NORMAL_COLUMN_OFFSET);
    }
