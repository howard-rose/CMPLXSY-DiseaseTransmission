...
public class KioskGraphic extends MallAmenityGraphic {
    ...
    public KioskGraphic(Kiosk kiosk) {
        super(kiosk, ROW_SPAN, COLUMN_SPAN, NORMAL_ROW_OFFSET, NORMAL_COLUMN_OFFSET);
    }
