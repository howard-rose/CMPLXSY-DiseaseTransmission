    ...
    public static void draw(List<Patch> patches, String facing) {
        for (Patch patch : patches) {
            ...
            if (Objects.equals(facing, "UP")) {
                ...
                Patch patch3 = Main.universitySimulator.getUniversity().getPatch(origPatchRow + 1, origPatchCol);
                ...
                Patch patch4 = Main.universitySimulator.getUniversity().getPatch(origPatchRow + 1, origPatchCol + 1);
            ...
            Main.universitySimulator.getUniversity().getCabinets().add(cabinetToAdd);
