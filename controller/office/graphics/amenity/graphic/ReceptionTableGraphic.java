...
public class ReceptionTableGraphic extends OfficeAmenityGraphic {
    ...
    public ReceptionTableGraphic(ReceptionTable receptionTable) {
        super(receptionTable, ROW_SPAN, COLUMN_SPAN, NORMAL_ROW_OFFSET, NORMAL_COLUMN_OFFSET);
    }
