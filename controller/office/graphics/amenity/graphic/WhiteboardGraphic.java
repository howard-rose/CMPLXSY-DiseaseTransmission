...
public class WhiteboardGraphic extends OfficeAmenityGraphic {
    ...
    public WhiteboardGraphic(Whiteboard whiteboard) {
        super(whiteboard, ROW_SPAN, COLUMN_SPAN, NORMAL_ROW_OFFSET, NORMAL_COLUMN_OFFSET);
    }
